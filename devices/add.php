                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2">Register Device</h1>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row mb-2">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="staff" id="staff" class="form-control form-select">
                                                ...
                                                ?><option value="<?php echo $staff['name'];  ?>"><?php echo $staff['name']; ?></option><?php
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="os" id="os" class="form-control form-select">
                                                ...
                                                ?><option value="<?php echo $os['name'];  ?>"><?php echo $os['name']; ?></option><?php
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="memory_type" id="memory_type" class="form-control form-select">
                                                <option selected>Select Memory Type</option>
                                    ...
                                    <div class="row mb-2">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="branch" id="branch" class="form-control form-select">
                                                ...
                                                ?><option value="<?php echo $branch['name'];  ?>"><?php echo $branch['name']; ?></option><?php
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control form-select" name="architecture" id="">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control form-select" name="domain" id="">
                                                <option value="">Select</option>
                                                <option value="">None</option>
                                                <?php $domains = getDomain();
                                                foreach ($domains as $domain) :
                                                    echo "<option value = " . $domain['domain_name'] . '(' . $domain['domain_ip'] . ')' . ">"  . $domain['domain_name'] . '(' . $domain['domain_ip'] . ')' . "</option>";
                                    ...
                                    <div class="form-group col-md-4 ">
                                        ...
                                        <input class="btn btn-success form-control " name="add_device" type="submit" />
