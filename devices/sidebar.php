            ...
            <ul class="list-unstyled ps-0">
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse " id="dashboard-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="../incidents" class="link-dark rounded active">View</a></li>
                            <li><a href="../incidents/addform.php" class="link-dark rounded">New
                            Incident</a></li>
                    ...
                    <div class="collapse show" id="fca-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="./" class="link-dark rounded">View</a></li>
                             <li><a href="./add.php" class="link-dark rounded">Add Device</a></li>
...
<div class="modal fade" id="add_reporting_staff" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="../incidents/functions.php?source=devices" method="post">
...
<div class="modal fade" id="add_os" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="./functions.php?source=devices" method="post">
                <div class="modal-body">
                    <div class="form-group">
