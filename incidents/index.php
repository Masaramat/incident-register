            ...
            <div class="container-fluid">
                ...
                <table id="users_table" class="table table-striped table-bordered nowrap table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr valign="top">
                            <td><?php htmlout($incident['incident']); ?></td>
                            <td><?php htmlout($incident['reported_by']); ?></td>
                            <td><?php htmlout($incident['attended_by']); ?></td>
                            <td><?php htmlout($incident['category']); ?></td>
                            <td><?php htmlout($incident['status']); ?></td>
                            <td><?php htmlout($incident['reporting_date']); ?></td>
                            <td>
                                
                                <div>                                    
                                    <a class="bg-primary text-light" href="edit.php?id=<?php htmlout($incident['sno']); ?>">Edit</a>
                                </div>
